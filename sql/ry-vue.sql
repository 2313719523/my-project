...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '穿搭主表' ROW_FORMAT = Dynamic;
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, '0', '若依科技', 0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '深圳总公司', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (102, 100, '0,100', '长沙分公司', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (103, 101, '0,100,101', '研发部门', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (104, 101, '0,100,101', '市场部门', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (105, 101, '0,100,101', '测试部门', 3, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (106, 101, '0,100,101', '财务部门', 4, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (107, 101, '0,100,101', '运维部门', 5, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (108, 102, '0,100,102', '市场部门', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
INSERT INTO `sys_dept` VALUES (109, 102, '0,100,102', '财务部门', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2017 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 5, 'tool', NULL, '', '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2026-01-13 09:43:46', 'admin', '2026-01-23 17:58:58', '系统工具目录');
INSERT INTO `sys_menu` VALUES (4, '知识库调用', 0, 4, 'https://www.coze.cn/space/7597380186367426586/bot/7597380708080353280', NULL, '', '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', '2026-01-13 09:43:46', 'admin', '2026-01-26 09:57:51', '若依官网地址');
INSERT INTO `sys_menu` VALUES (100, '用户管理', 1, 1, 'user', 'system/user/index', '', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', '2026-01-13 09:43:46', '', NULL, '用户管理菜单');
INSERT INTO `sys_menu` VALUES (101, '角色管理', 1, 2, 'role', 'system/role/index', '', '', 1, 0, 'C', '0', '0', 'system:role:list', 'peoples', 'admin', '2026-01-13 09:43:46', '', NULL, '角色管理菜单');
INSERT INTO `sys_menu` VALUES (102, '菜单管理', 1, 3, 'menu', 'system/menu/index', '', '', 1, 0, 'C', '0', '0', 'system:menu:list', 'tree-table', 'admin', '2026-01-13 09:43:46', '', NULL, '菜单管理菜单');
INSERT INTO `sys_menu` VALUES (103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', '', 1, 0, 'C', '0', '0', 'system:dept:list', 'tree', 'admin', '2026-01-13 09:43:46', '', NULL, '部门管理菜单');
INSERT INTO `sys_menu` VALUES (104, '岗位管理', 1, 5, 'post', 'system/post/index', '', '', 1, 0, 'C', '0', '0', 'system:post:list', 'post', 'admin', '2026-01-13 09:43:46', '', NULL, '岗位管理菜单');
...
INSERT INTO `sys_menu` VALUES (107, '通知公告', 1, 8, 'notice', 'system/notice/index', '', '', 1, 0, 'C', '0', '0', 'system:notice:list', 'message', 'admin', '2026-01-13 09:43:46', '', NULL, '通知公告菜单');
INSERT INTO `sys_menu` VALUES (108, '日志管理', 1, 9, 'log', '', '', '', 1, 0, 'M', '0', '0', '', 'log', 'admin', '2026-01-13 09:43:46', '', NULL, '日志管理菜单');
INSERT INTO `sys_menu` VALUES (109, '在线用户', 2, 1, 'online', 'monitor/online/index', '', '', 1, 0, 'C', '0', '0', 'monitor:online:list', 'online', 'admin', '2026-01-13 09:43:46', '', NULL, '在线用户菜单');
INSERT INTO `sys_menu` VALUES (110, '定时任务', 2, 2, 'job', 'monitor/job/index', '', '', 1, 0, 'C', '0', '0', 'monitor:job:list', 'job', 'admin', '2026-01-13 09:43:46', '', NULL, '定时任务菜单');
INSERT INTO `sys_menu` VALUES (111, '数据监控', 2, 3, 'druid', 'monitor/druid/index', '', '', 1, 0, 'C', '0', '0', 'monitor:druid:list', 'druid', 'admin', '2026-01-13 09:43:46', '', NULL, '数据监控菜单');
...
INSERT INTO `sys_menu` VALUES (113, '缓存监控', 2, 5, 'cache', 'monitor/cache/index', '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list', 'redis', 'admin', '2026-01-13 09:43:46', '', NULL, '缓存监控菜单');
...
INSERT INTO `sys_menu` VALUES (2002, '单品管理', 2000, 2, '/wardrobe/item', 'wardrobe/item/index', NULL, '', 1, 0, 'C', '0', '0', 'wardrobe:item:list', 'component', 'admin', '2026-01-13 17:53:59', 'admin', '2026-01-23 17:51:55', '');
INSERT INTO `sys_menu` VALUES (2003, '衣橱首页', 2000, 1, 'index', 'wardrobe/index', NULL, '', 1, 0, 'C', '0', '0', 'wardrobe:index:view', 'dashboard', 'admin', '2026-01-23 17:34:16', 'admin', '2026-01-23 17:51:39', '');
...
INSERT INTO `sys_menu` VALUES (2005, '社区互动', 0, 4, 'outfit', 'outfit/outfit/index', NULL, '', 1, 0, 'C', '0', '0', 'outfit:outfit:list', 'peoples', 'admin', '2026-01-27 11:42:00', 'admin', '2026-01-27 14:55:06', '穿搭主菜单');
INSERT INTO `sys_menu` VALUES (2006, '穿搭主查询', 2005, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'system:outfit:query', '#', 'admin', '2026-01-27 11:42:00', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2007, '穿搭主新增', 2005, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'system:outfit:add', '#', 'admin', '2026-01-27 11:42:00', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2008, '穿搭主修改', 2005, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'system:outfit:edit', '#', 'admin', '2026-01-27 11:42:00', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2009, '穿搭主删除', 2005, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'system:outfit:remove', '#', 'admin', '2026-01-27 11:42:00', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2010, '穿搭主导出', 2005, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'system:outfit:export', '#', 'admin', '2026-01-27 11:42:00', '', NULL, '');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (1, '温馨提醒：2018-07-01 若依新版本发布啦', '2', 0xE696B0E78988E69CACE58685E5AEB9, '0', 'admin', '2026-01-13 09:43:47', '', NULL, '管理员');
INSERT INTO `sys_notice` VALUES (2, '维护通知：2018-07-01 若依系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', '2026-01-13 09:43:47', '', NULL, '管理员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 154 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_oper_log` VALUES (123, '代码生成', 6, 'GenController.importTableSave()', 'POST', 1, 'admin', '研发部门', '/tool/gen/importTable', '127.0.0.1', '内网IP', '{\"tables\":\"ry_outfit\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-01-27 10:44:12', 276);
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2026-01-13 09:43:46', '', NULL, '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', 'kk', '00', 'kk@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-01-30 11:28:41', '2026-01-13 09:43:46', 'admin', '2026-01-13 09:43:46', '', '2026-01-14 15:22:17', '管理员');
INSERT INTO `sys_user` VALUES (2, 105, 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-01-13 09:43:46', '2026-01-13 09:43:46', 'admin', '2026-01-13 09:43:46', '', NULL, '测试员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '衣橱单品表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wardrobe_item
-- ----------------------------
INSERT INTO `wardrobe_item` VALUES (6, '纯棉白衬衫', '上装', '白色', '春秋', 299.00, 1, '2024-03-15 00:00:00', '', '', '2026-01-13 17:16:21', '', NULL);
INSERT INTO `wardrobe_item` VALUES (7, '直筒牛仔裤', '下装', '蓝色', '四季', 459.00, 0, '2024-03-14 00:00:00', '', '', '2026-01-13 17:16:21', '', NULL);
INSERT INTO `wardrobe_item` VALUES (8, '运动跑鞋', '鞋履', '白色', '四季', 699.00, 1, '2024-03-13 00:00:00', '', '', '2026-01-13 17:16:21', '', NULL);
INSERT INTO `wardrobe_item` VALUES (9, '简约手表', '配饰', '银色', '四季', 1299.00, 0, '2024-03-12 00:00:00', '', '', '2026-01-13 17:16:21', '', NULL);
INSERT INTO `wardrobe_item` VALUES (10, '羊毛大衣', '外套', '驼色', '冬季', 1599.00, 1, '2024-03-11 00:00:00', '', '', '2026-01-13 17:16:21', '', NULL);
