package com.kk.common.utils.file;
...
import com.kk.common.exception.file.FileNameLengthLimitExceededException;
import com.kk.common.exception.file.FileSizeLimitExceededException;
import com.kk.common.exception.file.InvalidExtensionException;
import com.kk.common.utils.uuid.IdUtils;
import com.kk.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = KKConfig.getProfile();
    ...
    {
        int dirLastIndex = KKConfig.getProfile().length() + 1;
